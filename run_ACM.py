...
def main(args):
    ADJ, NS, MG, features, labels, num_classes, train_idx, val_idx, test_idx, type_mask,pos = load_ACM_data()
    ...
    for cur_repeat in range(args['repeat']):
        ...
        nmi_avg += nmi
        ari_avg += ari
        # with open('results_acm.txt', 'a') as file:
...
if __name__ == '__main__':
    ...
    for i in range(1):
        for j in range(1):
            ...
            parser.add_argument('--patience', type=int, default=15, help='耐心值')
            ...
            parser.add_argument('--margin1', type=float, default=0.8, help='')#0.8
            parser.add_argument('--margin2', type=float, default=0.2, help='')#0.2
            parser.add_argument('--w_loss1', type=float, default=60, help='')#60高阶异质信息
            parser.add_argument('--w_loss2', type=float, default=60, help='')#局部信息
